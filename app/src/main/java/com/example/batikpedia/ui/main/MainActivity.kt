...
import com.example.batikpedia.ui.guide.GuideActivity
import com.example.batikpedia.ui.listarticle.ListArticleActivity
import com.example.batikpedia.ui.listbatik.ListBatikActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setClickDashboard(){
        binding.cardView1.setOnClickListener {
            //intent to list batik activity
            val intent = Intent(this, ListBatikActivity::class.java)
            startActivity(intent)
        }
        binding.cardView2.setOnClickListener {
            //intent to list article activity
